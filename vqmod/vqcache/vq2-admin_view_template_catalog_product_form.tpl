...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><i class="ion-grid"></i> <?php echo $heading_title; ?></h1>
      <div class="buttons row button-group">
					...
					<li><a onclick="$('#form').submit();"><i class="ion-checkmark-circled"></i> <?php echo $button_save; ?></a></li>
					<li class="divider"></li>
					<li><a href="<?php echo $cancel; ?>"><i class="ion-ios7-undo"></i> <?php echo $button_cancel; ?></a></li>
					</ul>
					</div>
				</div>
    </div>
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="table table-bordered-row">
              <tr>
                ...
                <td style="width:60%"><input type="text" name="product_description[<?php echo $language['language_id']; ?>][name]"  value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
                  <?php if (isset($error_name[$language['language_id']])) { ?>
                  <span class="error alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> <?php echo $error_name[$language['language_id']]; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
                <td><?php echo $entry_meta_description; ?></td>
                <td style="width:90%"><textarea name="product_description[<?php echo $language['language_id']; ?>][meta_description]"  rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_meta_keyword; ?></td>
                <td style="width:90%"><textarea name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]"  rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_description; ?></td>
                <td style="width:90%"><textarea name="product_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_tag; ?></td>
                <td style="width:60%"><input type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tag'] : ''; ?>"  /></td>
              </tr>
            </table>
          </div>
          <?php } ?>
        ...
        <div id="tab-data">
          <table class="table table-bordered-row">
            <tr>
              ...
              <td style="width:60%"><input type="text" name="model" value="<?php echo $model; ?>" />
                <?php if ($error_model) { ?>
                <span class="error alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> <?php echo $error_model; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_sku; ?></td>
              <td style="width:60%"><input type="text" name="sku" value="<?php echo $sku; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_upc; ?></td>
              <td style="width:60%"><input type="text" name="upc" value="<?php echo $upc; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_ean; ?></td>
              <td style="width:60%"><input type="text" name="ean" value="<?php echo $ean; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_jan; ?></td>
              <td style="width:60%"><input type="text" name="jan" value="<?php echo $jan; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_isbn; ?></td>
              <td style="width:60%"><input type="text" name="isbn" value="<?php echo $isbn; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_mpn; ?></td>
              <td style="width:60%"><input type="text" name="mpn" value="<?php echo $mpn; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_location; ?></td>
              <td style="width:60%"><input type="text" name="location" value="<?php echo $location; ?>" /></td>
            </tr>
            <tr>
                <td><?php echo $entry_price; ?></td>
                <td style="width:60%"><input type="text" name="price" value="<?php echo $price; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_tax_class; ?></td>
              <td style="width:60%"><select name="tax_class_id">
            ...
            <tr>
              ...
              <td style="width:60%"><input type="text" name="quantity" value="<?php echo $quantity; ?>" size="2" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_minimum; ?></td>
              <td style="width:60%"><input type="text" name="minimum" value="<?php echo $minimum; ?>" size="2" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_subtract; ?></td>
              <td style="width:60%"><select name="subtract">
                  <?php if ($subtract) { ?>
            ...
            <tr>
              ...
              <td style="width:60%"><select name="stock_status_id">
            ...
            <tr>
              ...
              <td style="width:60%"><input type="text" name="keyword" value="<?php echo $keyword; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_image; ?></td>
              <td><div class="image"><img src="<?php echo $thumb; ?>" alt="" id="thumb" /><br />
                  <input type="hidden" name="image" value="<?php echo $image; ?>" id="image" />
                  <a class="btn btn-info" onclick="image_upload('image', 'thumb');"><i class="ion-image"></i> <?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class="btn btn-default" onclick="$('#thumb').attr('src', '<?php echo $no_image; ?>'); $('#image').attr('value', '');"><i class="ion-ios7-loop-strong"></i> <?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
              <td><?php echo $entry_date_available; ?></td>
              <td style="width:60%"><input type="text" name="date_available" value="<?php echo $date_available; ?>" size="12" class="date" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_dimension; ?></td>
              <td style="width:60%"><input type="text" name="length" value="<?php echo $length; ?>" size="4" />
            ...
            <tr>
              ...
              <td style="width:60%"><select name="length_class_id">
            ...
            <tr>
              ...
              <td style="width:60%"><input type="text" name="weight" value="<?php echo $weight; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_weight_class; ?></td>
              <td style="width:60%"><select name="weight_class_id">
            ...
            <tr>
              ...
              <td style="width:60%"><select name="status">
                  <?php if ($status) { ?>
            ...
            <tr>
              ...
              <td style="width:60%"><input type="text" name="sort_order" value="<?php echo $sort_order; ?>" size="2" /></td>
            </tr>
          </table>
        </div>
        <div id="tab-links">
          <table class="table table-bordered-row">
            <tr>
              ...
              <td style="width:60%"><input type="text" name="manufacturer" value="<?php echo $manufacturer ?>" /><input type="hidden" name="manufacturer_id" value="<?php echo $manufacturer_id; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_category; ?></td>
              <td style="width:60%"><input type="text" name="category" value="" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td style="width:60%"><input type="text" name="filter" value="" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td><div class="scrollbox">
                  ...
                  <div class="<?php echo $class; ?>">
                    ...
                    <input class="check-access" type="checkbox" name="product_store[]" value="0" checked="checked" />
                    <?php echo $text_default; ?>
                    <?php } else { ?>
                    <input class="check-access" type="checkbox" name="product_store[]" value="0" />
                    <?php echo $text_default; ?>
                    <?php } ?>
                  </div>
                  ...
                  <div class="<?php echo $class; ?>">
                    ...
                    <input class="check-access" type="checkbox" name="product_store[]" value="<?php echo $store['store_id']; ?>" checked="checked" />
                    <?php echo $store['name']; ?>
                    <?php } else { ?>
                    <input class="check-access" type="checkbox" name="product_store[]" value="<?php echo $store['store_id']; ?>" />
                    <?php echo $store['name']; ?>
                    <?php } ?>
                  </div>
                  <?php } ?>
            ...
            <tr>
              ...
              <td style="width:60%"><input type="text" name="download" value="" /></td>
            </tr>			
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td style="width:60%"><input type="text" name="related" value="" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
        ...
        <div id="tab-attribute">
          <table id="attribute" class="table">
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                ...
                <td class="left"><?php foreach ($languages as $language) { ?>
                  <textarea name="product_attribute[<?php echo $attribute_row; ?>][product_attribute_description][<?php echo $language['language_id']; ?>][text]"  rows="5"><?php echo isset($product_attribute['product_attribute_description'][$language['language_id']]) ? $product_attribute['product_attribute_description'][$language['language_id']]['text'] : ''; ?></textarea>
                  <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" align="top" /><br />
                  <?php } ?></td>
                <td class="left"><a onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="btn btn-danger delete"><i class="ion-android-trash"></i> <?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $attribute_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left"><a onclick="addAttribute();" class="btn btn-info insert"><i class="ion-ios7-plus"></i> <?php echo $button_add_attribute; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <div id="tab-option-<?php echo $option_row; ?>" class="vtabs-content">
            ...
            <table class="table table-bordered-row">
              <tr>
                ...
                <td style="width:60%"><select name="product_option[<?php echo $option_row; ?>][required]">
              ...
              <tr>
                ...
                <td style="width:60%"><input type="text" name="product_option[<?php echo $option_row; ?>][option_value]" value="<?php echo $product_option['option_value']; ?>" /></td>
              </tr>
              <?php } ?>
              <?php if ($product_option['type'] == 'textarea') { ?>
              <tr>
                <td><?php echo $entry_option_value; ?></td>
                <td style="width:90%"><textarea name="product_option[<?php echo $option_row; ?>][option_value]"  rows="5"><?php echo $product_option['option_value']; ?></textarea></td>
              </tr>
              <?php } ?>
              ...
              <tr>
                <td><?php echo $entry_option_value; ?></td>
                <td style="width:60%"><input type="text" name="product_option[<?php echo $option_row; ?>][option_value]" value="<?php echo $product_option['option_value']; ?>" class="date" /></td>
              </tr>
              <?php } ?>
              <?php if ($product_option['type'] == 'datetime') { ?>
              <tr>
                <td><?php echo $entry_option_value; ?></td>
                <td style="width:60%"><input type="text" name="product_option[<?php echo $option_row; ?>][option_value]" value="<?php echo $product_option['option_value']; ?>" class="datetime" /></td>
              </tr>
              <?php } ?>
              <?php if ($product_option['type'] == 'time') { ?>
              <tr>
                <td><?php echo $entry_option_value; ?></td>
                <td style="width:60%"><input type="text" name="product_option[<?php echo $option_row; ?>][option_value]" value="<?php echo $product_option['option_value']; ?>" class="time" /></td>
              </tr>
              <?php } ?>
            </table>
            ...
            <table id="option-value<?php echo $option_row; ?>" class="table">
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  ...
                  <td class="left"><a onclick="$('#option-value-row<?php echo $option_value_row; ?>').remove();" class="btn btn-danger delete"><i class="ion-android-trash"></i> <?php echo $button_remove; ?></a></td>
                </tr>
              </tbody>
              ...
              <tfoot>
                <tr>
                  <td colspan="6"></td>
                  <td class="left"><a onclick="addOptionValue('<?php echo $option_row; ?>');" class="btn btn-info insert"><i class="ion-ios7-plus"></i> <?php echo $button_add_option_value; ?></a></td>
                </tr>
              </tfoot>
            </table>
        ...
        <div id="tab-profile">
            <table class="table table-bordered-row">
                ...
                <tbody>
                    ...
                    <?php foreach ($product_profiles as $product_profile): ?>
                        ...
                        <tr id="profile-row<?php echo $profileCount ?>">
                            ...
                            <td class="left">
                                <a class="btn btn-danger" onclick="$('#profile-row<?php echo $profileCount ?>').remove()"><i class="ion-android-trash"></i> <?php echo $button_remove ?></a>
                            </td>
                        </tr>
                ...
                <tfoot>
                    <tr>
                        <td colspan="2"></td>
                        <td class="left"><a onclick="addProfile()" class="btn btn-info insert"><i class="ion-ios7-plus"></i> <?php echo $button_add_profile ?></a></td>
                    </tr>
                </tfoot>
            </table>
        </div>
          ...
          <table id="discount" class="table">
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#discount-row<?php echo $discount_row; ?>').remove();" class="btn btn-danger delete"><i class="ion-android-trash"></i> <?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $discount_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="6"></td>
                <td class="left"><a onclick="addDiscount();" class="btn btn-info insert"><i class="ion-ios7-plus"></i> <?php echo $button_add_discount; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <table id="special" class="table">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#special-row<?php echo $special_row; ?>').remove();" class="btn btn-danger delete"><i class="ion-android-trash"></i> <?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $special_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="5"></td>
                <td class="left"><a onclick="addSpecial();" class="btn btn-info insert"><i class="ion-ios7-plus"></i> <?php echo $button_add_special; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <div id="tab-image">
          <table id="images" class="table">
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr>
                <td class="left"><div class="image"><img src="<?php echo $product_image['thumb']; ?>" alt="" id="thumb<?php echo $image_row; ?>" />
                    ...
                    <br />
                    <a class="btn btn-info" onclick="image_upload('image<?php echo $image_row; ?>', 'thumb<?php echo $image_row; ?>');"><i class="ion-image"></i> <?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class="btn btn-default" onclick="$('#thumb<?php echo $image_row; ?>').attr('src', '<?php echo $no_image; ?>'); $('#image<?php echo $image_row; ?>').attr('value', '');"><i class="ion-ios7-loop-strong"></i> <?php echo $text_clear; ?></a></div></td>
                ...
                <td class="left"><a onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="btn btn-danger delete"><i class="ion-android-trash"></i> <?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $image_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left"><a onclick="addImage();" class="btn btn-info insert"><i class="ion-ios7-camera"></i> <?php echo $button_add_image; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <div id="tab-reward">
          <table class="table table-bordered-row">
            <tr>
              ...
              <td style="width:60%"><input type="text" name="points" value="<?php echo $points; ?>" /></td>
            </tr>
          </table>
          <table class="table table-bordered-row">
            <thead>
...
function addAttribute() {
	...
	html += '    <td class="left">';
	<?php foreach ($languages as $language) { ?>
	html += '<textarea name="product_attribute[' + attribute_row + '][product_attribute_description][<?php echo $language['language_id']; ?>][text]"  rows="5"></textarea><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" align="top" /><br />';
    <?php } ?>
	html += '    </td>';
	html += '    <td class="left"><a onclick="$(\'#attribute-row' + attribute_row + '\').remove();" class="btn btn-danger delete"><i class="ion-android-trash"></i> <?php echo $button_remove; ?></a></td>';
    html += '  </tr>';	
    html += '</tbody>';
...
$('input[name=\'option\']').catcomplete({
	...
	select: function(event, ui) {
		...
		html += '       <td style="width:60%"><select name="product_option[' + option_row + '][required]">';
		...
		if (ui.item.type == 'text') {
			...
			html += '       <td style="width:60%"><input type="text" name="product_option[' + option_row + '][option_value]" value="" /></td>';
			html += '     </tr>';
		}
		...
		if (ui.item.type == 'textarea') {
			html += '     <tr>';
			html += '       <td><?php echo $entry_option_value; ?></td>';
			html += '       <td style="width:90%"><textarea name="product_option[' + option_row + '][option_value]"  rows="5"></textarea></td>';
			html += '     </tr>';						
		}
		...
		if (ui.item.type == 'date') {
			html += '     <tr>';
			html += '       <td><?php echo $entry_option_value; ?></td>';
			html += '       <td style="width:60%"><input type="text" name="product_option[' + option_row + '][option_value]" value="" class="date" /></td>';
			html += '     </tr>';			
		}
		...
		if (ui.item.type == 'datetime') {
			html += '     <tr>';
			html += '       <td><?php echo $entry_option_value; ?></td>';
			html += '       <td style="width:60%"><input type="text" name="product_option[' + option_row + '][option_value]" value="" class="datetime" /></td>';
			html += '     </tr>';			
		}
		...
		if (ui.item.type == 'time') {
			html += '     <tr>';
			html += '       <td><?php echo $entry_option_value; ?></td>';
			html += '       <td style="width:60%"><input type="text" name="product_option[' + option_row + '][option_value]" value="" class="time" /></td>';
			html += '     </tr>';			
		}
		...
		if (ui.item.type == 'select' || ui.item.type == 'radio' || ui.item.type == 'checkbox' || ui.item.type == 'image') {
			...
			html += '        <td class="left"><a onclick="addOptionValue(' + option_row + ');" class="btn btn-info insert"><i class="ion-ios7-plus"></i> <?php echo $button_add_option_value; ?></a></td>';
			html += '      </tr>';
			html += '    </tfoot>';
			html += '  </table>';
...
function addOptionValue(option_row) {	
	...
	html += '    <td class="left"><a onclick="$(\'#option-value-row' + option_value_row + '\').remove();" class="btn btn-danger delete"><i class="ion-android-trash"></i> <?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
...
function addDiscount() {
	...
	html += '    <td class="left"><a onclick="$(\'#discount-row' + discount_row + '\').remove();" class="btn btn-danger delete"><i class="ion-android-trash"></i> <?php echo $button_remove; ?></a></td>';
	html += '  </tr>';	
    html += '</tbody>';
...
function addSpecial() {
	...
	html += '    <td class="left"><a onclick="$(\'#special-row' + special_row + '\').remove();" class="btn btn-danger delete"><i class="ion-android-trash"></i> <?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
    html += '</tbody>';
...
function image_upload(field, thumb) {
	...
	$('#content').prepend('<div id="dialog" class="embed-responsive embed-responsive-16by9" style="padding: 3px 0px 0px 0px;"><iframe class="embed-responsive-item"  src="index.php?route=common/filemanager&token=<?php echo $token; ?>&field=' + encodeURIComponent(field) + '" style="padding:0; margin: 0; display: block; width: 100%; height: 100%;" frameborder="no" scrolling="auto"></iframe></div>');
...
function addImage() {
	...
	html += '  <tr>';
	html += '    <td class="left"><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + image_row + '" /><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="image' + image_row + '" /><br /><a class="btn btn-info" onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');"><i class="ion-image"></i> <?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class="btn btn-default" onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><i class="ion-ios7-loop-strong"></i> <?php echo $text_clear; ?></a></div></td>';
	html += '    <td class="right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="" size="2" /></td>';
	html += '    <td class="left"><a onclick="$(\'#image-row' + image_row  + '\').remove();" class="btn btn-danger delete"><i class="ion-android-trash"></i> <?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
...
function addProfile() {
    ...
    html += '  </td>';
    html += '  <td class="left">';
    html += '    <a class="btn btn-danger" onclick="$(\'#profile-row' + profileCount + '\').remove()"><i class="ion-android-trash"></i> <?php echo $button_remove ?></a>';
    html += '  </td>';
    html += '</tr>';
