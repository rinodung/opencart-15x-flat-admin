    ...
    <div class="heading">
      <h1><i class="ion-grid"></i> <?php echo $heading_title; ?></h1>
			...
			<div class="buttons row button-group">
				...
				<li><a onclick="$('#form').attr('action', '<?php echo $copy; ?>'); $('#form').submit();"><i class="ion-ios7-browsers"></i> <?php echo $button_copy; ?></a></li>
				<li class="divider"></li>
        ...
        <table class="table table-bordered-row">
          ...
          <tbody>
            <tr class="filter">
              <td></td>
              <td></td>
              <td style="width:60%"><input type="text" name="filter_name" value="<?php echo $filter_name; ?>" /></td>
              <td style="width:60%"><input type="text" name="filter_model" value="<?php echo $filter_model; ?>" /></td>
              ...
              <td style="width:60%"><select name="filter_status">
                  <option value="*"></option>
              ...
              <td align="right"><a class="btn btn-default" onclick="filter();"><i class="ion-funnel"></i> <?php echo $button_filter ?></a></td>
            </tr>
            <?php if ($products) { ?>
            <?php foreach ($products as $product) { ?>
            <tr>
              <td style="text-align: center;"><?php if ($product['selected']) { ?>
                <input class="check-access" type="checkbox" name="selected[]" value="<?php echo $product['product_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input class="check-access" type="checkbox" name="selected[]" value="<?php echo $product['product_id']; ?>" />
                <?php } ?></td>
              <td class="center"><img class="cover" src="<?php echo $product['image']; ?>" alt="<?php echo $product['name']; ?>" /></td>
