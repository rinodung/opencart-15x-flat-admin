          ...
          <div class="product-thumb">
            ...
            <div class="caption">
              ...
              <p class="price">
                ...
                <?php global $config; if($config->get('marketshop_percentage_discount_badge')== 1) { ?><span class="saving">-<?php echo $product['saving']; ?>%</span><?php } ?>
                <?php } ?>
                <?php if ($product['tax']) { ?>
            ...
            <div class="button-group">
              <button class="btn-primary" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span></button>
...
<?php global $config; if($config->get('marketshop_special_product_per_row')== 'pr3') { ?>
  	<?php if ($column_left && $column_right) { ?>
...
if (localStorage.getItem('display') == 'list') {
    ...
    <?php } ?>
  <?php } elseif ($config->get('marketshop_special_product_per_row')== 'pr4') {?>
	<script type="text/javascript">
$(document).ready(function(){
$(document).on('click', '#grid-view', function(e){
...
if (localStorage.getItem('display') == 'list') {
  ...
  <?php } elseif ($config->get('marketshop_special_product_per_row')== 'pr5') {?>
	<script type="text/javascript">
$(document).ready(function(){
...
if (localStorage.getItem('display') == 'list') {
  ...
  <?php } elseif ($config->get('marketshop_special_product_per_row')== 'pr6') {?>
    <script type="text/javascript">
$(document).ready(function(){
