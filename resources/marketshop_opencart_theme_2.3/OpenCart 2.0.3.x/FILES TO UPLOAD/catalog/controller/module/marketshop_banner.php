...
class ControllerModuleMarketshopbanner extends Controller {
	public function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/marketshop_banner.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/marketshop_banner.tpl', $data);
		} else {
			return $this->load->view('default/template/module/marketshop_banner.tpl', $data);
		}
	}
}