<?php if($filter_groups || $tags || $categories || $options || $manufacturers || $attributes || $price_slider) { ?>
<style type="text/css">
...
<div  class="box" id="adv_ajaxfilter_box">
  <div class="box-heading">
    ...
    <div class="clear_filter"> <a title="<?php echo $clear_filter?>"></a> </div>
  </div>
  <div class="box-content" style="margin: 0; padding: 0">
    <form id="adv_ajaxfilter">
      ...
      <div class="option_box">
        <div class="option_name <?php if(!$expanded_filters){echo "hided";} ?>"><?php echo $filter_group['name']; ?></div>
        <div class="collapsible" <?php if(!$expanded_filters){echo 'style="display:none"';}?>>
          <ul>
      ...
      <div class="option_box">
        ...
        <div class="collapsible brand" <?php if(!$expanded_manufacturer){echo 'style="display:none"';}?>>
