...
if((isset($marketshop_contact[$lang]) && $marketshop_contact[$lang] != '') || (isset($marketshop_about_details[$lang]) && $marketshop_about_details[$lang] != '')) { ?>
        ...
        <div class="column col-lg-2 col-md-2 col-sm-3 col-xs-12">
          ...
          <ul>
            ...
            <?php if($config->get('marketshop_affiliate_status')== 1) { ?>
    ...
    <div class="container">
      <div id="powered" class="clearfix">
        <div class="powered_text pull-left flip">
          <?php $marketshop_powered = $config->get('marketshop_powered'); if(isset($marketshop_powered[$lang])){echo html_entity_decode($marketshop_powered[$lang], ENT_QUOTES, 'UTF-8');} ?>
        </div>
        <?php
...
if($config->get('marketshop_paypal') != '' || $config->get('marketshop_american') != '' || $config->get('marketshop_2checkout') != '' || $config->get('marketshop_discover') != '' || $config->get('marketshop_maestro') != '' || $config->get('marketshop_mastercard') != '' || $config->get('marketshop_sagepay') != '' || $config->get('marketshop_visa') != '' || $config->get('marketshop_moneybooker') != '' || $config->get('marketshop_cirrus') != '' || $config->get('marketshop_delta') != '' || $config->get('marketshop_direct') != '' || $config->get('marketshop_google') != '' || $config->get('marketshop_western_union') != '' || $config->get('marketshop_ebay') != '' || $config->get('marketshop_solo') != '' || $config->get('marketshop_switch') != '') { ?>
        ...
        if ($config->get('marketshop_custom_payment_image') != ''){ ?>
          ...
          <a href="<?php echo $config->get('marketshop_custom_payment_image_url'); ?>" target="_blank"> <img src="<?php echo $path_image . $config->get('marketshop_custom_payment_image') ?>" alt="Payment" title="Payment"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_paypal_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_paypal.png" alt="paypal" title="PayPal"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_american_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_american.png" alt="american-express" title="American Express"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_2checkout_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_2checkout.png" alt="2checkout" title="2checkout"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_maestro_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_maestro.png" alt="maestro" title="Maestro"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_discover_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_discover.png" alt="discover" title="Discover"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_mastercard_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_mastercard.png" alt="mastercard" title="MasterCard"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_visa_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_visa.png" alt="visa" title="Visa"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_sagepay_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_sagepay.png" alt="sagepay" title="sagepay"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_moneybookers_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_moneybookers.png" alt="moneybookers" title="Moneybookers"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_cirrus_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_cirrus.png" alt="cirrus" title="Cirrus"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_delta_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_delta.png" alt="delta" title="Delta"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_direct_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_direct.png" alt="direct" title="direct"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_google_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_google.png" alt="google" title="google"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_solo_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_solo.png" alt="solo" title="solo"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_switch_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_switch.png" alt="switch" title="switch"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_western_union_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_western_union.png" alt="western_union" title="western union"></a>
          <?php else: ?>
          ...
          <a href="<?php echo $config->get('marketshop_ebay_url'); ?>" target="_blank"> <img data-toggle="tooltip" src="catalog/view/theme/marketshop/image/payment_ebay.png" alt="ebay" title="ebay"></a>
          <?php else: ?>
...
<div id="custom_side_block" class="<?php if($config->get('marketshop_custom_side_block_align')== 1){ ?>custom_side_block_left<?php } ?><?php if($config->get('marketshop_custom_side_block_align')== 2){ ?>custom_side_block_right<?php } ?>" style="<?php if($config->get('marketshop_custom_side_block_sort_order')== 1){ ?>top:210px; z-index:10000;<?php } ?><?php if($config->get('marketshop_custom_side_block_sort_order')== 2){ ?>top:270px; z-index:9999;<?php } ?><?php if($config->get('marketshop_custom_side_block_sort_order')== 3){ ?>top:330px; z-index:9998;<?php } ?><?php if($config->get('marketshop_custom_side_block_sort_order')== 4){ ?>top:390px; z-index:9997;<?php } ?>">
  ...
  <?php echo html_entity_decode($marketshop_custom_column[$lang], ENT_QUOTES, 'UTF-8'); ?> </div>
<?php if($config->get('marketshop_custom_side_block_align')== 1){ ?>
<script>
$(function(){        
