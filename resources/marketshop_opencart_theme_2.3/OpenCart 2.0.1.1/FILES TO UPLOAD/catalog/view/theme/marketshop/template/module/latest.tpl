...
<script type="text/javascript">
	$(document).ready(function() {
		...
		itemsCustom : [[320, 1],[600, 2],[768, 3],[992, <?php global $config; echo $config->get('marketshop_latest_slider_product_per_row'); ?>],[1199, <?php echo $config->get('marketshop_latest_slider_product_per_row'); ?>]],											   
		lazyLoad : true,
		navigation : true,
