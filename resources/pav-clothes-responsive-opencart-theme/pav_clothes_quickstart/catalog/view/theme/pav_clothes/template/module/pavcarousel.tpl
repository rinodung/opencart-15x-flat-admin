...
?>
<div id="pavcarousel<?php echo $id;?>" class="carousel slide box nobackground pavcarousel hidden-xs">
	...
	<div class="carousel-inner">
		...
		<div class="item <?php if($k==0) {?>active<?php } ?>">
			...
			<div class="row">
				<?php } ?>
				<div class="item-carousel col-xs-6 col-lg-<?php echo $span;?> col-md-<?php echo $span;?> col-sm-<?php echo $span;?>">
