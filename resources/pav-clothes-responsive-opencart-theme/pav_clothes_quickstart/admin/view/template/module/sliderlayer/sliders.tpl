														...
														<td>
															...
															<div class="buttons">
																...
																<a class="btn btn-warning btn-sm" href="<?php echo  $objurl->link('module/pavsliderlayer/export', 'id='.$id.'&token=' . $objsession->data['token'], 'SSL');?>"  class="btn orange" id="preview-sliders">
																	...
																	<a class="btn btn-danger btn-sm" href="<?php echo  $objurl->link('module/pavsliderlayer/deleteGroup', 'id='.$id.'&token=' . $objsession->data['	token'], 'SSL');?>" onclick="return confirm('Are you sure to delete this');" class="btn " id="preview-sliders">
