						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td class="left">
										<a href="<?php echo $objurl->link('module/pavblog/blog','id='.$comment['blog_id'].'&token='.$token);?>">
									...
									<td class="right">
										<a href="<?php echo $objurl->link('module/pavblog/comment','id='.$comment['comment_id'].'&token='.$token);?>"><?php echo $objlang->get('text_edit');?></a>
									</td>
								</tr>
								<?php } ?>
							</tbody>
