										...
										<div class="tab-pane " id="tab-module-language-<?php echo $language["language_id"]; ?>">
											<table class="table noborder">
												<tr>
													...
													<td class="col-sm-10">
														<textarea id="description-<?php echo $language["language_id"]; ?>" name="description[<?php echo $language['language_id']; ?>]">
												...
												<tr>
													...
													<td class="col-sm-10">
														<textarea id="social-<?php echo $language["language_id"]; ?>" name="social[<?php echo $language['language_id']; ?>]">
...
<?php foreach ($languages as $language) {?>
	...
	$("#social-<?php echo $language["language_id"]; ?>").summernote({ height: 150 });
<?php } ?>
