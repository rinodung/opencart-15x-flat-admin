...
abstract class  PtsWidgetPageBuilder extends Model {
	...
	public function getLayout( $layout ){  
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/widgets/'.$layout.'.tpl')) {
			$template = DIR_TEMPLATE.$this->config->get('config_template') . '/template/module/widgets/'.$layout.'.tpl';
		} else {
