			...
			<div class="panel-body" style="height:520px;">
				...
				<div class="col-sm-7">
					<div class="tool-icons clearfix" style="width:100%">
						...
						<ul>
							<li><a href="<?php echo $menus["create_newsletter"]["link"];?>"><span class="icon-blogs icon"></span><span><?php echo $objlang->get('menu_create_newsletter')?></span></a></li>
							<li><a href="<?php echo $menus["draft"]["link"];?>"><span class="icon-addcategory icon"></span><span><?php echo $objlang->get('menu_manage_draft_newsletters')?></span></a></li>
