			...
			<tr>
				...
				<td class="col-sm-2">
					<ul class="nav nav-tabs" id="language-profile-<?php echo $banner_row; ?>">
			            ...
			            <li><a href="#tab-language-profile<?php echo $banner_row; ?>-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
			            <?php } ?>
		          	</ul>
			...
			<tr>
				...
				<td class="col-sm-2">
					<ul class="nav nav-tabs" id="language<?php echo $banner_row; ?>">
			            <?php foreach ($languages as $language) { ?>
			            <li><a href="#tab-module<?php echo $banner_row; ?>-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
			            <?php } ?>
			        </ul>
...
function addModule() {
	...
	html += '  <ul class="nav nav-tabs" id="language-profile-' + banner_row + '">';
  	<?php foreach ($languages as $language) { ?>
	html += '    <li><a href="#tab-language-profile' + banner_row + '-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>';
	<?php } ?>
	html += '  </ul>';
	...
	html += '  <ul class="nav nav-tabs" id="language' + banner_row + '">';
  	<?php foreach ($languages as $language) { ?>
	html += '    <li><a href="#tab-module' + banner_row + '-language<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>';
	<?php } ?>
	html += '  </ul>';
	html += '  <div class="tab-content">';
	<?php foreach ($languages as $language) { ?>
