...
<script type="text/javascript">
	$('div.typo').on('click', function(e) {
		...
		$("#<?php echo $layer_id; ?>.draggable-item.iview-caption.tp-caption.layer-text.ui-draggable.ui-draggable-handle.layer-active").data( "data-form", $( '#slider-form', window.parent.document ).serializeArray() );
