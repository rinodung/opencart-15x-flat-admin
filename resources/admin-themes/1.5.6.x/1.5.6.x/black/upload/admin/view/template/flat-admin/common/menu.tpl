<ul id="menu">
	...
	<li id="catalog"><a class="parent"><span class="glyphicon glyphicon-list-alt"></span> <?php echo $text_catalog; ?></a>
        <ul>
			...
			<li><a href="<?php echo $profile; ?>"><i class="ion-bag"></i> <?php echo $text_profile; ?></a></li>
	...
	<li id="extension"><a class="parent"><span class="glyphicon glyphicon-cog"></span> <?php echo $text_extension; ?></a>
        <ul>
			...
			<li><a class="parent"><i class="ion-star"></i> <?php echo $text_openbay_extension; ?></a>
				<ul>
					<li><a href="<?php echo $openbay_link_extension; ?>"><i class="ion-ios7-gear"></i> <?php echo $text_openbay_dashboard; ?></a></li>
					<li><a href="<?php echo $openbay_link_orders; ?>"><i class="ion-ios7-filing"></i> <?php echo $text_openbay_orders; ?></a></li>
					<li><a href="<?php echo $openbay_link_items; ?>"><i class="ion-grid"></i> <?php echo $text_openbay_items; ?></a></li>
					<?php if($openbay_markets['ebay'] == 1){ ?>
					<li><a class="parent"><i class="ion-star"></i> <?php echo $text_openbay_ebay; ?></a>
						<ul>
							<li><a href="<?php echo $openbay_link_ebay_settings; ?>"><i class="ion-ios7-gear"></i> <?php echo $text_openbay_settings; ?></a></li>
							<li><a href="<?php echo $openbay_link_ebay_links; ?>"><i class="ion-grid"></i> <?php echo $text_openbay_links; ?></a></li>
							<li><a href="<?php echo $openbay_link_ebay_orderimport; ?>"><i class="ion-ios7-filing"></i> <?php echo $text_openbay_order_import; ?></a></li>
						</ul>
					</li>
					<?php } ?>
					<?php if($openbay_markets['amazon'] == 1){ ?>
					<li><a class="parent"><i class="ion-star"></i> <?php echo $text_openbay_amazon; ?></a>
						<ul>
							<li><a href="<?php echo $openbay_link_amazon; ?>"><i class="ion-ios7-gear"></i> <?php echo $text_openbay_amazon; ?></a></li>
							<li><a href="<?php echo $openbay_link_amazon_settings; ?>"><i class="ion-ios7-gear"></i> <?php echo $text_openbay_settings; ?></a></li>
							<li><a href="<?php echo $openbay_link_amazon_links; ?>"><i class="ion-grid"></i> <?php echo $text_openbay_links; ?></a></li>
						</ul>
					</li>
					<?php } ?>
					<?php if($openbay_markets['amazonus'] == 1){ ?>
					<li><a class="parent"><i class="ion-star"></i> <?php echo $text_openbay_amazonus; ?></a>
						<ul>
							<li><a href="<?php echo $openbay_link_amazonus; ?>"><i class="ion-ios7-gear"></i> <?php echo $text_openbay_amazonus; ?></a></li>
							<li><a href="<?php echo $openbay_link_amazonus_settings; ?>"><i class="ion-ios7-gear"></i> <?php echo $text_openbay_settings; ?></a></li>
							<li><a href="<?php echo $openbay_link_amazonus_links; ?>"><i class="ion-grid"></i> <?php echo $text_openbay_links; ?></a></li>
						</ul>
					</li>
					<?php } ?>
				</ul>
	...
	<li id="sale"><a class="parent"><span class="glyphicon glyphicon-shopping-cart"></span> <?php echo $text_sale; ?></a>
        <ul>
			...
			<li><a href="<?php echo $recurring_profile; ?>"><i class="ion-ios7-clock-outline"></i> <?php echo $text_recurring_profile; ?></a></li>
			...
			<li><a class="parent"><i class="ion-card"></i> <?php echo $text_paypal_express; ?></a>
				<ul>
					<li><a href="<?php echo $paypal_express; ?>"><i class="ion-card"></i> <?php echo $text_paypal_express; ?></a></li>
					<li><a href="<?php echo $paypal_express_search; ?>"><i class="ion-card"></i> <?php echo $text_paypal_express_search; ?></a></li>
				</ul>
			</li>
			<?php } ?>
