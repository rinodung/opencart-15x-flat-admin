<div id="cart">
  <div class="heading">
  	<span><?php echo $heading_title; ?><span><br/>
  	<a><span class="cartImgWrap"><img class="cartImg" src="catalog/view/theme/valentino/image/cart.png" alt="Shopping cart" ></span><span id="cart-total"><?php echo $text_items; ?></span></a>
  </div>
  <div class="content">
