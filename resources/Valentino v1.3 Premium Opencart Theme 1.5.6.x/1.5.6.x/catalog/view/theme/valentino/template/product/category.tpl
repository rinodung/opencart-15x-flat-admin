...
<?php if ($thumb) { ?>
	<div class="imageCategory"><img src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" /></div>
<?php } ?>
...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="category-list">
    <?php if (count($categories) <= 5) { ?>
      ...
      <div class="span4"><h4><a href="<?php echo $category['href']; ?>" class="subCatName"><?php echo $category['name']; ?></a></h4></div>
      <?php } ?>
   	  </div>
    <?php } else { ?>
    ...
    <div class="row">
      ...
      <<div class="span4"><h4><a href="<?php echo $categories[$i]['href']; ?>" class="subCatName"><?php echo $categories[$i]['name']; ?></a></h4></div>
      <?php } ?>
      <?php } ?>
    </div>
    <?php } ?>
