...
class ControllerModuleCameraSlideshow extends Controller {
	protected function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/camera_slideshow.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/camera_slideshow.tpl';
		} else {
			$this->template = 'default/template/module/camera_slideshow.tpl';
		}
