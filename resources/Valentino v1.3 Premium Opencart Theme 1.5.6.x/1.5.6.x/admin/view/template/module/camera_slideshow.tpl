      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="left"><select name="camera_slideshow_module[<?php echo $module_row; ?>][banner_id]">
              ...
              <td class="left"><input type="text" name="camera_slideshow_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
                <input type="text" name="camera_slideshow_module[<?php echo $module_row; ?>][height]" value="<?php echo $module['height']; ?>" size="3"/>
              ...
              <!-- choose span -->
              <td>
              	<select name="camera_slideshow_module[<?php echo $module_row; ?>][span]">
              ...
              <td class="left"><select name="camera_slideshow_module[<?php echo $module_row; ?>][layout_id]">
              ...
              <td class="left"><select name="camera_slideshow_module[<?php echo $module_row; ?>][position]">
                  ...
                  <?php } ?>
				  <!-- new position -->
              	  <?php if ($module['position'] == 'content_top_full_width') { ?>
                       <option value="content_top_full_width" selected="selected">Content Top Full Width</option>
                    <?php } else { ?>
                       <option value="content_top_full_width">Content Top Full Width</option>
                    <?php } ?>
                  <!-- /new position -->
                  <!-- new position -->
              ...
              <td class="left"><select name="camera_slideshow_module[<?php echo $module_row; ?>][status]">
              ...
              <td class="right"><input type="text" name="camera_slideshow_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
...
function addModule() {	
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="camera_slideshow_module[' + module_row + '][banner_id]">';
	<?php foreach ($banners as $banner) { ?>
	html += '      <option value="<?php echo $banner['banner_id']; ?>"><?php echo addslashes($banner['name']); ?></option>';
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="left"><input type="text" name="camera_slideshow_module[' + module_row + '][width]" value="" size="3" /> <input type="text" name="camera_slideshow_module[' + module_row + '][height]" value="" size="3" /></td>';
	
	html += '    <td class="left"><select name="camera_slideshow_module[' + module_row + '][span]">';
	...
	html += '      <option value="FullWidth">Full width</option>';
	html += '    </select></td>';
	
	html += '    <td class="left"><select name="camera_slideshow_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	html += '      <option value="<?php echo $layout['layout_id']; ?>"><?php echo addslashes($layout['name']); ?></option>';
	<?php } ?>
	html += '    </select></td>';
	
	html += '    <td class="left"><select name="camera_slideshow_module[' + module_row + '][position]">';
	html += '      <option value="content_top"><?php echo $text_content_top; ?></option>';
	// new position
	html += '      <option value="content_top_full_width">Content Top Full Width</option>';
	//
	// new position
	...
	html += '    <td class="left"><select name="camera_slideshow_module[' + module_row + '][status]">';
    html += '      <option value="1" selected="selected"><?php echo $text_enabled; ?></option>';
    html += '      <option value="0"><?php echo $text_disabled; ?></option>';
    html += '    </select></td>';
	html += '    <td class="right"><input type="text" name="camera_slideshow_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
